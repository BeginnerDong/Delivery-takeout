<template>
	<div>
		...
		<div class="pdlr4">
			<div class="line40">用户评价</div>
			<div>
				<textarea  disabled="disabled" class="w radius5 fs12 color6" style=" min-height: 80px;max-height: 100px;box-sizing: border-box;border: none; background: #f8f8f8;padding: 10px; display: block;color: #333;" rows="" cols="" placeholder="" value="退款原因退款原因退款原因退款原因退款原因退款原因退款原因"></textarea>
			</div>
		</div>

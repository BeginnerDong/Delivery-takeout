<template>
	<div>
		...
		<div class="pdlr4">
			...
			<div>
				<textarea  disabled="disabled" class="w radius5 fs12 color6" style=" min-height: 80px;box-sizing: border-box;border: none; background: #f8f8f8;padding: 15px; display: block;" rows="" cols="" placeholder="">退款原因退款原因退款原因退款原因退款原因退款原因退款原因</textarea>
			</div>
		</div>
		<div class="pdlr4 mgt15">
			<div class="line40">商家回复</div>
			<div>
				<textarea class="w radius5 fs12 color6" style=" height: 100px;box-sizing: border-box;border: none; background: #f8f8f8;padding: 10px; display: block;color: #333;" rows="" cols="" placeholder="" value="请输入您的退款结果"></textarea>
			</div>
		</div>
